...
export const translations: Record<Lang, Dict> = {
  en: {
    ...
    "about.ceo.exp1": "30+ years in timber manufacturing",
    ...
    "home.process.desc":
      "From first consultation to delivery — a streamlined four-step workflow refined over 30 years of timber manufacturing.",
    "home.process.s1.title": "You send a request",
    "home.process.s1.text": "Drawings, dimensions, material choice, deadline — in any format.",
    "home.process.s2.title": "We review",
    "home.process.s2.text": "Our team evaluates the options and prepares an initial assessment within 24–48 hours.",
    "home.process.s3.title": "You receive an offer",
    "home.process.s3.text": "A detailed quote with price, lead time and specifications.",
    "home.process.s4.title": "Production & delivery",
    "home.process.s4.text": "Once approved and the 50% deposit is paid, we start production and deliver.",
  ...
  lv: {
    ...
    "about.ceo.exp1": "30+ gadu pieredze koksnes ražošanā",
    ...
    "home.process.desc":
      "No pirmās konsultācijas līdz piegādei — vienkāršs četru soļu process, ko esam pilnveidojuši 30 gadu laikā.",
